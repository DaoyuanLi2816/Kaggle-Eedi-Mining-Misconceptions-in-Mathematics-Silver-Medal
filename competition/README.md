> **Provenance note** — this is the original competition write-up, preserved as-is.
> The files formerly under `code/` now live in this directory; the generalized,
> tested library extracted from this solution lives at the repository root
